...
{
    [CreateAssetMenu(fileName = "PlayerStatsScriptableObject", menuName = "Scriptable Objects/Player Stats Scriptable Object")]
    public class PlayerStatsScriptableObject : ScriptableObject
    {
        ...
        [Tooltip("A constant downward force applied while grounded. Helps on slopes"), Range(-10f, -20f)]
        public float GroundingForceBigBall = -10f;
        ...
        [Header("Bounce")]
        public float HeightPercentageMultiplier = 0.3f;
        public float BounceDecayMultiplier = 0.6f;
